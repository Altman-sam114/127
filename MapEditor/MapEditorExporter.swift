    ...
    private static func makeScenarioDefinition(from document: MapEditorDocument) -> ScenarioDefinition {
        ...
        return ScenarioDefinition(
            ...
            dataNotes: [
                ...
                "Standalone exports do not carry the Grey Tide release-candidate objective gates; overwrite the default operation through the game resource bridge to preserve them."
            ]
        )
    }
