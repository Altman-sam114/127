...
- 元帅、国家约束、联合司令部、Chief of Staff、ISR / Fires / Air / EW / Logistics / Brigade roles 已进入当前指挥链，其中 ISR Recon Area 已有受限 `Command.recon` 执行桥，Fires Fire Mission 已有受限 `Command.fireMission` 执行桥
