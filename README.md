...
本轮继续收口 compatibility fallback 显示：旧地名、旧 raw id 和旧编辑器生成区域名进入 Region inspector、Mission target summary 或选区反馈时，会显示为 `Compatibility Area`，但底层 region / theater / front-zone id、地图数据和命令目标不变。
