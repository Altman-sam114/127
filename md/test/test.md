...
- `probe-xctest.log`：`WWIIHexV0Probes` 云端 simulator probe 日志，需核对灰潮 10 个 AI 半回合 probe、Playtest 状态 probe、Observer AI 容器入口 probe 和 restricted / civilian fire ROE probe 用例执行并通过。
