...
flowchart TD
    ...
    GHA["GitHub Actions<br/>ci-results.yml<br/>diff / plist / xml / Ruby 脚本<br/>+ 云端 xcodebuild build<br/>+ Grey Tide AI half-turn probe<br/>+ Playtest / objective victory / Recon / Observer / restricted fire ROE probes"]:::cloud
