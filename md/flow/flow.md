...
Playtest Loop
  ...
  -> Player Side / Opposition / Control Mode
...
- Playtest 面板显示 `Player Side`、`Opposition` 和 `Control Mode`，明确当前发布候选中玩家扮演 Blue Joint Task Force，对手由当前局面 hostile faction 推导；完整红/蓝选择器留待后续版本。
